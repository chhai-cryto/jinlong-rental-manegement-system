...
<head>
    ...
    <title>Jinlong Rental Management System</title>
    ...
    <main class="ml-64 flex-1"> 
        ...
        <header class="bg-gray-200 shadow px-6 py-5 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <input type="text" placeholder="Search..."class="pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
                    <span class="absolute left-3 top-2.5 text-gray-400"><i class="fa-solid fa-magnifying-glass"></i></span>
                </div>

                <div class="flex items-center space-x-2 cursor-pointer">

                    <img src="https://i.pravatar.cc/40" alt="Admin"class="w-10 h-10 rounded-full">
